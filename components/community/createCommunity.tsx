...
import EsusuCommunity from "./EsusuCommuity"
...
const CreateCommunity: React.FC<CreateCommunityProps> = ({ communityname }) => {
    ...
    return (
        <div className="bg-[#113A47] min-h-[85vh] flex flex-col items-center justify-center">
            {createCommunity ? (
                <EsusuCommunity />
            ) : (
                <div>
                    <h1 className="text-2xl font-bold mb-6 mt-[0]">
                    ...
                    <div className="border-2 border-[#16D7A6] rounded-[8px] w-full max-w-md mx-[60px] p-8 bg-[#113A47] text-white shadow-lg">
                        <p className="text-[#72ddd1] mb-6">
                            Select details carefully to ensure accuracy before submitting your
                        ...
                        <form onSubmit={handleFormSubmit} className="space-y-4">
                            ...
                            <button type="submit" className="w-full bg-[#16D7A6] text-white font-bold py-2 px-4 rounded-md hover:bg-[#0EAF8B] transition">
                                Create Community
                            </button>
                        </form>
                    </div>
